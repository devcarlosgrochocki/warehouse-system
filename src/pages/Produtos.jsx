...
import { formatCurrency, generateId, validateProductCode } from '../utils/helpers';
...
const Produtos = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!validateProductCode(formData.codigo)) {
      alert('Código deve ter entre 3-10 caracteres, apenas letras maiúsculas e números');
      return;
    }
            ...
            {produtos.map((produto) => (
              <tr key={produto.id}>
                <td className="px-6 py-4 whitespace-nowrap">
                  ...
                  <div className="text-sm text-gray-500">Por {produto.unidade}</div>
                </td>
                ...
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                  <span className={`${produto.estoque <= 10 ? 'text-red-600 font-bold' : ''}`}>
                    {produto.estoque}
                  </span>
                </td>
        ...
        <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 w-full max-w-md">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700">Unidade de Venda</label>
                <select
